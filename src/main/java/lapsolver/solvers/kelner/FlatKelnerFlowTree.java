/**
 * @file FlatKelnerFlowTree.java
 * @author Cyril Zhang <cyril.zhang@yale.edu>
 * @date Tue Jun 17 2014
 *
 * An implementation of the cycle update data structure in the paper of Kelner et al.
 * Uses the sparse vector dot product representation to flatten queries and updates
 * after an initial recursive tree decomposition.
 */
...
public class FlatKelnerFlowTree extends FlowTree {
    public SeparatorNode rootStructure;
    public ArrayList<SeparatorNode> nodes;

    // base constructor
    public FlatKelnerFlowTree (Tree tree, EdgeList offEdges) {
        super(tree, offEdges);
